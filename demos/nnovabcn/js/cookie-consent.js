...
function CookieConsent(props) {
    ...
    self.props = {
        ...
        defaultLang: "es", // default language, if the `lang` is not available as translation in `cookie-consent-content`
        content: [], // deprecated, we now have a `content` folder, which contains the language files
        contentUrl: "./cookies", // the url of the "cookie-consent-content" folder, which contains the language files
